...
function OrderSuccessful(props) {
  return (
    <Svg
      ...
      {...props}
    >
      <Circle cx={74} cy={73} r={52} fill="url(#paint0_radial_2594_40747)" />
      <Path
        d="M65.892 83.101a2 2 0 01-2.828 0l-9.568-9.569a2 2 0 00-2.824-.005l-1.38 1.371a2 2 0 00-.006 2.834l13.777 13.777a2 2 0 002.829 0L98.72 58.68a2 2 0 000-2.828l-1.362-1.362a2 2 0 00-2.827-.001L65.89 83.101z"
        fill="#fff"
        stroke="#fff"
        strokeWidth={2}
      />
